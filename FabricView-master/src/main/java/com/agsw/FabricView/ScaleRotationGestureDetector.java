...
import static com.agsw.FabricView.FabricView.ROTATE_MODE;
...
public class ScaleRotationGestureDetector extends ScaleGestureDetector {
    ...
    public boolean onTouchEvent(MotionEvent event){
      /*  if(fabricView.getInteractionMode()==ROTATE_MODE){
            rotationListener.onScaleBegin(this);
            Log.v("check", "2");
        }*/
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP:
               ...
               // rotationListener.onScaleEnd(this);
                break;
